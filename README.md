...
| `scarajectory/core/service/trajectory_validator.py` | 100 | 19 | 81%|
...
| `scarajectory/infrastructure/communication/protocol/command_formatter.py` | 12 | 0 | 100%|
| `scarajectory/infrastructure/communication/protocol/command_templates.py` | 44 | 2 | 95%|
| `scarajectory/infrastructure/communication/protocol/config_command_formatter.py` | 22 | 4 | 82%|
| `scarajectory/infrastructure/communication/protocol/motion_command_formatter.py` | 57 | 9 | 84%|
| `scarajectory/infrastructure/communication/protocol/protocol_parser.py` | 83 | 28 | 66%|
...
| `scarajectory/infrastructure/communication/serial_port_scanner.py` | 36 | 7 | 81%|
| `scarajectory/infrastructure/communication/serial_streamer.py` | 162 | 95 | 41%|
...
| `scarajectory/infrastructure/gui/components/streamer_tab.py` | 112 | 41 | 63%|
