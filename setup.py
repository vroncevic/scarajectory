...
Info
    Defines setup for scarajectory package.
'''
...
setup(
    ...
    url='https://github.com/vroncevic/scarajectory',
    license='GNU General Public License (GPL)',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='scara, trajectory, cad, cam, motion-planning, robotics, serial-streamer',
    platforms='POSIX',
