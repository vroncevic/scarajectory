...
class TrajectoryTable(Frame):
    ...
    def _create_widgets(self) -> None:
        ...
        self._tree = Treeview(self, columns=cols, show='headings', height=10, selectmode='browse')
        ...
        scrollbar: Scrollbar = Scrollbar(self, orient=VERTICAL, command=self._tree.yview)
