...
class StreamStatusBar(Frame):
    ...
    def _create_widgets(self) -> None:
        '''
            ...
            :exceptions: None.
        '''
        self._progress_bar = Progressbar(self, maximum=100.0)
        self._progress_bar.pack(fill=X, pady=3)

        self._lbl_status = Label(self, text='Streamer: Disconnected', font=('DejaVu Sans', 9, 'bold'))
