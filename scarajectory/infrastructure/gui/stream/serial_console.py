...
class SerialConsole(LabelFrame):
    ...
    def _create_widgets(self) -> None:
        ...
        Button(top, text='Clear Log', command=self.clear_log).pack(side=RIGHT, padx=(4, 0))
        Button(top, text='Copy', command=self.copy_log).pack(side=RIGHT, padx=(4, 0))
        Button(top, text='Select All', command=self.select_all).pack(side=RIGHT, padx=(4, 0))
