...
Info
    Implementation of ICommandParser parsing tactile sensor PROBE commands.
'''
...
class ProbeCommandParser:
    '''
        Command parser handler for tactile surface contact search PROBE instructions.
        ...
        It defines:
            ...
            :attributes:
                | None.
            :methods:
                | can_parse - Checks whether command is PROBE.
                | parse - Parses probe statement tokens into ScaraInstruction.
    '''

    def can_parse(self, *, command_name: str) -> bool:
        '''
            Checks if command is PROBE.

            :param command_name: Command keyword string.
            :return: True if match, False otherwise.
        '''
        return command_name == 'PROBE'
    ...
    def parse(
        ...
        *,
        ...
        '''
            Parses probe statement into ScaraInstruction.
        ...
        return ScaraInstruction(
            command_type=ScaraCommandType.PROBE,
