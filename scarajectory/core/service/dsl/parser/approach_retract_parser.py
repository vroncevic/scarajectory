...
Info
    Implementation of ICommandParser parsing relative vertical APPROACH and RETRACT commands.
'''
...
class ApproachRetractParser:
    '''
        Command parser handler for vertical APPROACH and RETRACT instructions.
        ...
        It defines:
            ...
            :attributes:
                | None.
            :methods:
                | can_parse - Checks whether command is APPROACH or RETRACT.
                | parse - Parses approach/retract statement tokens into ScaraInstruction.
    '''

    def can_parse(self, *, command_name: str) -> bool:
        '''
            Checks if command is APPROACH or RETRACT.

            :param command_name: Command keyword string.
            :return: True if match, False otherwise.
        '''
        return command_name in ('APPROACH', 'RETRACT')
    ...
    def parse(
        ...
        *,
        ...
        '''
            Parses approach or retract statement into ScaraInstruction.
