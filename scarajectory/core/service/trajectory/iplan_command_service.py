...
Info
    Defines interface IPlanCommandService for trajectory authoring and history commands.
'''
...
@runtime_checkable
class IPlanCommandService(Protocol):
    '''
        Interface for trajectory authoring lifecycle and undo/redo commands.
