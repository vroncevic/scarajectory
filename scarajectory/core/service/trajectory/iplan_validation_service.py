...
Info
    Defines interface IPlanValidationService for trajectory kinematic validation.
'''
...
@runtime_checkable
class IPlanValidationService(Protocol):
    '''
        Interface for kinematic and geometric trajectory validation.
