...
Info
    Interface protocol for trajectory undo and redo transaction history.
'''
...
@runtime_checkable
class ITrajectoryHistory(Protocol):
    '''
        Interface protocol for undo and redo transaction history.
